...
<head>
	...
	@font-face {
		...
		src: url("Microton[1738].TTF") format("truetype");
	}
	</style>
...
<body onload="doClear();clearFreq()">
	<center>
		...
		and inflected by up to 3 19-limit strokes each signifying ca. 1/6-comma</em><br /><br />
		<em>primes to include</em><br />
		<input type="checkbox" class="filter" id="filter3" checked> 3
		&nbsp;
		&nbsp;
		<input type="checkbox" class="filter" id="filter5" checked> 5
		&nbsp;
		&nbsp;
		...
		&nbsp;
		&nbsp;
		<input type="checkbox" class="filter" id="filter17" checked> 17
		&nbsp;
		&nbsp;
		<input type="checkbox" class="filter" id="filter19" checked> 19
		&nbsp;
		&nbsp;
		<input type="checkbox" class="filter" id="filter29" checked> 29
		&nbsp;
		&nbsp;
		<input type="checkbox" class="filter" id="filterall"> all/none<br>
		<table>		
		...
		<p style="font-size:14px;line-height:130%">
			<a href="https://creativecommons.org/licenses/by-nc-sa/4.0/" target=_blank>cc</a> 2018 <a href="http://www.thomasnicholson.ca" target=_blank>Thomas Nicholson</a>, Version 2.1
			<br>
