...
<body onload="doClear();clearFreq()">
	<center>
		...
		<table>
			...
			<h2>TUNING METER SETTING</h2>
					...
					<input type="radio" name="refInput" id="refFrequencyFreeRadio"><em>1/1 cents relative to A4 setting</em><br><br>
	...
	single = 512:513 </em>|<em> double = 255:256 </em>|<em> triple = 144:145</em><br /><br />
		...
		<p style="font-size:14px;line-height:130%">
			<a href="https://creativecommons.org/licenses/by-nc-sa/4.0/" target=_blank>cc</a> 2020 <a href="http://www.thomasnicholson.ca" target=_blank>Thomas Nicholson</a>, Version 2.3 (11.4.2020)
			<br>
