...
<body onload="sendA()">
	<center>
		...
		<a href="https://www.plainsound.org" target=_blank>plainsound.org</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="johnston.html">JOHNSTON to H-E Converter</a><br />
		<br>
		...
		<table>
			<tr align="center" style="border-bottom: solid 1px gray;">
				<td nowrap style="border-right: solid 1px gray;">
					<h2><b>REFERENCE</b><br />spelling & frequency of 1/1</h2>
				</td>
				<td nowrap>
					<h2><b>INPUT</b><br /><input type="radio" name="inputType" id="paletteInput" checked> by notation palette</h2>
				</td>
				<td nowrap style="border-right: solid 1px gray;">
					<h2><b>INPUT</b><br /><input type="radio" name="inputType" id="ratioInput"> by ratio (offset × input)</h2>
				</td>
				<td style="min-width:280px" nowrap>
					<h2><b>OUTPUT</b><br />	<br /></h2>
				</td>
				<td nowrap style="border-right: solid 1px gray;">
					<h2><b>MELODIC DISTANCE</b><br />between ratio I and II<br /></h2>
				</td>
				<td nowrap>
			...
			<tr align="center">
				<td nowrap style="border-right: solid 1px gray;">
					...
					<input type="number" style="text-align:center;font-size:12pt" id="1to1Frequency" value="440.000000"></input><br /><br>
					<hr>
					<br />
					...
					<input type="number" style="text-align:center;font-size:12pt" id="frequencyA4" value="440.000000"></input><br />
					<br />
					<button id="clearFreq" class="clear" onclick="clearFreq()">reset ref</button>
				</td>
				<td nowrap>
					<em>octave (SPN)</em><br />
