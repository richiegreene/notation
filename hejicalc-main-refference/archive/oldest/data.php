...
$centSearch = "SELECT * FROM enharmonictable WHERE cents>=($centValue-$centRange) AND cents<=($centValue+$centRange) AND (hd>=$hdMin) AND (hd<=$hdMax) AND $filter3 AND $filter5 AND $filter7 AND $filter11 AND $filter13 AND $filter17 AND $filter19 AND $filter23 AND $filter29 AND (acc<=$maxAcc) $sort;";
