 ...
 * people hear an interval exactly — an aliased partial is a pitch nobody
 * asked for, landing in the range being compared.
 *
 ...
 *
 * Kept from the app this came from, and used here by the same reasoning the
 * MPE path already uses its pitch-bend slide: a chord led to new frequencies
 * is one gesture, and a voice stopped and restarted to reach them would
 * re-attack in the middle of it.
 */
